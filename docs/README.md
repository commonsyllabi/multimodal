...
# MultiModal makes tools built for the way we research, write, discuss and share today. 
## Our goal is to promote a workflow centric approach to the design of authoring tools that prioritizes non-linear authoring workflows and interoperability.     
