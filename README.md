...
![main board page with topics](https://github.com/opensyllabi/multimodal/blob/main/docs/assets/tutorial_board_1.png)


#### DISPLAY THE TOPICS AND SESSIONS

![main board page](https://github.com/opensyllabi/multimodal/blob/main/docs/assets/tutorial_board_2.png)
...
![topic page](https://github.com/opensyllabi/multimodal/blob/main/docs/assets/tutorial_topic_display.png)

#### EDIT MODE

![topic page in edit mode](https://github.com/opensyllabi/multimodal/blob/main/docs/assets/tutorial_topic.png)
